...
public class ControllerImpl implements Controller {
    ...
    public String addPlayer(String fieldName, String playerType, String playerName, String nationality, int strength) {
        ...
        if (!ifPlayerCannotPlayOnField(fieldName, playerType)){
    ...
    private boolean ifPlayerCannotPlayOnField(String fieldName, String playerType) {
        boolean canPlay = true;
        if (playerType.equals("Women") && fieldName.equals("ArtificialTurf")){
            canPlay = false;
        } else if (playerType.equals("Men") && fieldName.equals("NaturalGrass")){
            canPlay = false;
        }
        return canPlay;
    }
